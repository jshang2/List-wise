...
limi = 200;
endt = 400;
loglikefun=@(vars)mloglike_help(vars(1),vars(2),vars(3),x,y,t,geoid,race,vars(4:7),Top,unique_geoids,TradeTemp,limi,endt);
...
save(strcat(word,'_maccuracy',int2str(IndeTemp),'.mat'),'intercept','K0','w','theta','pai15','pai50',...
